...
def _copy_sets_html(copy_sets: list) -> str:
    ...
    for i, cs in enumerate(copy_sets):
        ...
        cards += (
            ...
            f'letter-spacing:0.1em;margin-right:6px">メインキャッチ</span>'
            ...
            f'<div style="margin-bottom:5px">'
            f'<span style="font-size:0.63rem;font-weight:700;color:#64748b;text-transform:uppercase;'
            f'letter-spacing:0.1em;margin-right:6px">サブキャッチ</span>'
            ...
            f'<span style="font-size:0.63rem;font-weight:700;color:#64748b;'
